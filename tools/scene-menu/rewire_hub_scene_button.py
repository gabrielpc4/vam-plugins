...
Examples:
  python Custom/Scripts/tools/scene-menu/rewire_hub_scene_button.py --button-id TopLeftB7 \\
      --scene-json "Gato87/My Pack/Scene.json"
  python Custom/Scripts/tools/scene-menu/rewire_hub_scene_button.py --button-id TopLeftB7 \\
      --hub-rel "./Gato87/My Pack/Scene.json" --dry-run
  python Custom/Scripts/tools/scene-menu/rewire_hub_scene_button.py --list-pack-dirs --pack-under .
  python Custom/Scripts/tools/scene-menu/rewire_hub_scene_button.py --button-id RightTopB6 \\
