...
4. Update `Custom/Scripts/Gabriel/features/scene-camera/FEATURE.md` in the same turn whenever behavior, owned files, load paths, inputs, settings, or dependencies change.
