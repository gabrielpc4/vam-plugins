...
namespace geesp0t
{
    ...
    /// </summary>
    public class EasyMateClothingTouchFallOff : MVRScript
    {
            ...
            float now)
        {
            ...
            {
                SuperController.LogError("EasyMateClothingTouchFallOff: EnableUndressOnClothingItem failed: " + e.Message);
                return false;
            }
        }
        ...
        public override void Init()
        {
            try
            {
                ...
                {
                    SuperController.LogError("EasyMateClothingTouchFallOff: apply only to a Person atom.");
                    return;
                }
                ...
                if (_selector == null)
                {
                    SuperController.LogError("EasyMateClothingTouchFallOff: no DAZCharacterSelector (geometry) on " + containingAtom.uid);
                }
            }
            catch (Exception e)
            {
                SuperController.LogError("EasyMateClothingTouchFallOff Init: " + e);
            }
        }
        ...
        private void DestroyLegacyRelays()
        {
            if (_person == null)
                return;
            EasyMateClothingFallOffRelay[] all = _person.GetComponentsInChildren<EasyMateClothingFallOffRelay>(true);
    ...
    public sealed class EasyMateClothingFallOffRelay : MonoBehaviour
    {
    }
}
