...
namespace geesp0t
{
    ...
    /// <see cref="GabrielHud"/> skips Spankings merge on first VR grip for this load.
    /// </summary>
    public static class SpankingsGripBlockPathKeywords
    {
        ...
        public const string KeywordsFileRelative =
            "Custom/Scripts/Gabriel/features/spankings/spankings_grip_merge_block_path_keywords.txt";
