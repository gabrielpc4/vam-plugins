...
Run from repo / VaM root (folder that contains ``Saves/scene/`` and ``Custom/Scripts/tools/scene-menu/``):
  python Custom/Scripts/tools/scene-menu/inject_default_scene_thumbnails.py
"""
