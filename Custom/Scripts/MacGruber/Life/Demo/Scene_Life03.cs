// Scene_Life03 v1.1 by MacGruber
...
namespace MacGruber
{
    ...
    {	
		...
		private JSONStorableFloat myThrustRhythmDamping;
        ...
        public override void Init()
		{
			...
			myThrustRhythmDamping = thrust.GetFloatJSONParam("Rhythm Damping");
		}
        ...
        private void Update()
		{
			...
			if (intensityChangeClock >= intensityChangeDuration)
			{
				...
				myThrustRhythmDamping.val = data.thrustRhythmDamping;
		...
		private class IntensityData
		{
			...
			public float thrustRhythmDamping = 0.5f;
