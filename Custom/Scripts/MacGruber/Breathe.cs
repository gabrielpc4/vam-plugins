...
namespace MacGruber
{
    ...
    {
		private static readonly string SCENE_DIR = "Custom/Scripts/MacGruber/Breathe/";
		...
		public JSONStorableBool playAudioIfClear;
        ...
        public override void Init()
        {
            try
            {
                ...
                playAudioIfClear = new JSONStorableBool("Play Sounds When Head Silent", false);
                CreateToggle(playAudioIfClear);
                RegisterBool(playAudioIfClear);
                playAudioIfClear.storeType = JSONStorableParam.StoreType.Full;
        ...
        public void Update()
        {
			...
			{				
				...
				if (playAudioIfClear.val) {
					headAudio.CallAction("PlayIfClear", breatheEntry.audioClip);
				} else {
