...
namespace geesp0t
{
    ...
    /// </summary>
    public class SessionOrchestrator : MVRScript
    {
        private const string CoreControlAtomUid = "CoreControl";
        private const string HudClassSuffix = ".Hud";
        ...
        private void OnAtomUIDsChangedHandlers(List<string> atomUids)
        {
            ...
            {
                LogError(
                    "SessionOrchestrator path-rule E-Motion " +
        ...
        void Update()
        {
            ...
            if (sceneChanged)
            {
                ...
                sceneChanged = false;
                Log(
                    "SessionOrchestrator Scene Changed, Load Dir: " +
        ...
        void OnDestroy()
        {
            ...
            {
                SuperController.LogError(
                    "SessionOrchestrator.OnDestroy (reload teardown): " +
                    e.Message);
            }
        }
