...
namespace geesp0t
{
    ...
    /// <see cref="EasyMate"/> skips Spankings merge on first VR grip for this load.
    /// </summary>
    public static class EasyMateSpankingsGripBlockPathKeywords
    {
        /// <summary>
        ...
        public const string KeywordsFileRelative =
            "Custom/Scripts/Easy Mate/spankings_grip_merge_block_path_keywords.txt";

        private const string LogReadErrorPrefix = "EasyMate: read ";
