	...
	public class FingerMotionRightHand : MVRScript {
		...
		protected bool stateChanged;
			...
			uiFocusTarget.choices = targetChoices;
				...
				{
					newState = rightPinkyFingerBendSlider.val + rightRingFingerBendSlider.val + rightMidFingerBendSlider.val + rightIndexFingerBendSlider.val + rightFingersInOutSlider.val + rightThumbBendSlider.val + rightThumbFistSlider.val + rightThumbInOutSlider.val;
					...
					if (stateChanged == true || intensitySlider.val != intensityPreviousState)
					{
							...
							if (rightPinkyFingerBendSlider.val != 0 || stateChanged == true)
								rightPinkyFingerBend.morphValue = rightPinkyFingerBendSlider.val * intensitySlider.val;
							if (rightRingFingerBendSlider.val != 0 || stateChanged == true)
								rightRingFingerBend.morphValue  = rightRingFingerBendSlider.val  * intensitySlider.val;
							if (rightMidFingerBendSlider.val != 0 || stateChanged == true)
								rightMidFingerBend.morphValue  = rightMidFingerBendSlider.val  * intensitySlider.val;
							if (rightIndexFingerBendSlider.val != 0 || stateChanged == true)
								rightIndexFingerBend.morphValue   = rightIndexFingerBendSlider.val   * intensitySlider.val;
							if (rightFingersInOutSlider.val != 0 || stateChanged == true)
								rightFingersInOut.morphValue   = rightFingersInOutSlider.val   * intensitySlider.val;
							if (rightThumbBendSlider.val != 0 || stateChanged == true)
								rightThumbBend.morphValue   = rightThumbBendSlider.val   * intensitySlider.val;
							if (rightThumbFistSlider.val != 0 || stateChanged == true)
								rightThumbFist.morphValue   = (rightThumbFistSlider.val + 0.15f)   * intensitySlider.val;
							if (rightThumbInOutSlider.val != 0 || stateChanged == true)
        ...
        void Start()
        {
			previousState = rightPinkyFingerBendSlider.val + rightRingFingerBendSlider.val + rightMidFingerBendSlider.val + rightIndexFingerBendSlider.val + rightFingersInOutSlider.val + rightThumbBendSlider.val + rightThumbFistSlider.val + rightThumbInOutSlider.val;
			newState      =  rightPinkyFingerBendSlider.val + rightRingFingerBendSlider.val + rightMidFingerBendSlider.val + rightIndexFingerBendSlider.val + rightFingersInOutSlider.val + rightThumbBendSlider.val + rightThumbFistSlider.val + rightThumbInOutSlider.val;
			intensityPreviousState = intensitySlider.val;
			stateChanged = false;
