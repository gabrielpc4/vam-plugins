# Gabriel runtime optimization history

## Purpose

This file records performance-motivated Gabriel runtime changes so future
...
by the May 2026 Gabriel runtime audit and follow-up tuning.
...
- `Custom/Scripts/Gabriel/util/PersonAtomCache.cs`
- `Custom/Scripts/Gabriel/session-plugins/src/GabrielSessionOrchestrator.cs`
- `Custom/Scripts/Gabriel/features/hands/GripHandVisibility.cs`
- `Custom/Scripts/Gabriel/features/palm-hud/VrEulerPossessHandHud.cs`
- `Custom/Scripts/Gabriel/features/dildo-on-hands/DildoOnHands.cs`
- `Custom/Scripts/Gabriel/features/clothing-interactions/TriggerClothingRemover.cs`
...
- `Custom/Scripts/Gabriel/features/animation-no-loop-detection/AnimationNoLoopDetection.cs`
...
No single global "closest person" cache was added for all Gabriel systems.
