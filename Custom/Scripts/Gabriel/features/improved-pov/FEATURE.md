...
## Load Path
- Managed as a person plugin by `Custom/Scripts/Gabriel/session-stack/src/GabrielSessionStack.cs`.
...
- `session-stack` treats this as a managed male person-plugin path.
