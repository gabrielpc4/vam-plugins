...
{
    /// <summary>
    /// File: <c>HeadProximityHide.cs</c>. Easy Mate VR head zone: when the HMD eye is inside a **radial band** around a Person’s head (finite cylinder
    ...
    /// </summary>
    public static class HeadProximityHide
    {
        ...
        private static void OnPreRender(Camera cam)
        {
            ...
            {
                SuperController.LogError("HeadProximityHide pre-render: " + e);
            }
        }
        ...
        private static void OnPostRender(Camera cam)
        {
            ...
            {
                SuperController.LogError("HeadProximityHide post-render: " + e);
            }
        }
