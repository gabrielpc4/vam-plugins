...
4. Update `Custom/Scripts/Gabriel/features/passenger-possession/FEATURE.md` in the same turn whenever behavior, owned files, load paths, inputs, settings, or dependencies change.
