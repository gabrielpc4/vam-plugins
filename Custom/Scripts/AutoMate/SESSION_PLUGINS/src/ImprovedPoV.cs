...
namespace geesp0t
{
    public class ImprovedPoV
    {
        ...
        public JSONStorableBool _possessedOnlyJSON;
        ...
        {
            //SuperController.LogError("OnPreRender");
