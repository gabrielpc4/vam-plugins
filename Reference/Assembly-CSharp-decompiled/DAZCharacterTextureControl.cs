...
public class DAZCharacterTextureControl : JSONStorable
{
	...
	protected bool wasAppearanceRestore;
	...
	public override void LateRestoreFromJSON(JSONClass jc, bool restorePhysical = true, bool restoreAppearance = true, bool setMissingToDefault = true)
	{
		...
		wasAppearanceRestore = restoreAppearance;
	}

	public override void PostRestore()
	{
		base.PostRestore();
		if (wasAppearanceRestore)
		{
	...
	protected void SyncDiffuseGenitalTexture()
	{
		if (autoBlendGenitalTexturesJSON.val && torsoDiffuseUrlJSON.val != string.Empty)
		{
			...
			Texture2D inTorsoTex = (Texture2D)material.GetTexture("_MainTex");
			Texture2D value2 = BlendGenitalTexture(inTorsoTex, value, linear: false, colorAdjust: true);
			...
			foreach (int num3 in array)
			{
				...
				{
					Texture2D texture2D = (Texture2D)material3.GetTexture("_MainTex");
					if (!origDiffuseTextures.ContainsKey(material3))
					{
						origDiffuseTextures.Add(material3, texture2D);
					}
	...
	protected void SyncSpecularGenitalTexture()
	{
		if (autoBlendGenitalTexturesJSON.val && autoBlendGenitalSpecGlossNormalTexturesJSON.val && torsoSpecularUrlJSON.val != string.Empty)
		{
			...
			Texture2D inTorsoTex = (Texture2D)material.GetTexture("_SpecTex");
			Texture2D value2 = BlendGenitalTexture(inTorsoTex, value, linear: true, colorAdjust: false);
			int[] array = genitalMaterialNums;
			foreach (int num3 in array)
			{
				Material material3 = component.GPUmaterials[num3];
				...
				{
					Texture2D texture2D = (Texture2D)material3.GetTexture("_SpecTex");
					if (!origSpecularTextures.ContainsKey(material3))
					{
						origSpecularTextures.Add(material3, texture2D);
					}
	...
	protected void SyncGlossGenitalTexture()
	{
		if (autoBlendGenitalTexturesJSON.val && autoBlendGenitalSpecGlossNormalTexturesJSON.val && torsoGlossUrlJSON.val != string.Empty)
		{
			...
			Texture2D inTorsoTex = (Texture2D)material.GetTexture("_GlossTex");
			Texture2D value2 = BlendGenitalTexture(inTorsoTex, value, linear: true, colorAdjust: false);
			int[] array = genitalMaterialNums;
			foreach (int num3 in array)
			{
				...
				{
					Texture2D texture2D = (Texture2D)material3.GetTexture("_GlossTex");
					if (!origGlossTextures.ContainsKey(material3))
					{
						origGlossTextures.Add(material3, texture2D);
					}
	...
	protected void SyncNormalGenitalTexture()
	{
		if (autoBlendGenitalTexturesJSON.val && autoBlendGenitalSpecGlossNormalTexturesJSON.val && torsoNormalUrlJSON.val != string.Empty)
		{
			...
			Texture2D inTorsoTex = (Texture2D)material.GetTexture("_BumpMap");
			Texture2D value2 = BlendGenitalTexture(inTorsoTex, value, linear: true, colorAdjust: false, isNormalMap: true);
			int[] array = genitalMaterialNums;
			foreach (int num3 in array)
			{
				Material material3 = component.GPUmaterials[num3];
				...
				{
					Texture2D texture2D = (Texture2D)material3.GetTexture("_BumpMap");
					if (!origNormalTextures.ContainsKey(material3))
					{
						origNormalTextures.Add(material3, texture2D);
					}
	...
	public override void InitUI()
	{
		...
		DAZCharacterTextureControlUI componentInChildren = UITransform.GetComponentInChildren<DAZCharacterTextureControlUI>();
	...
	public override void InitUIAlt()
	{
		...
		DAZCharacterTextureControlUI componentInChildren = UITransformAlt.GetComponentInChildren<DAZCharacterTextureControlUI>();
		if (!(componentInChildren != null))
		{
			return;
		}
