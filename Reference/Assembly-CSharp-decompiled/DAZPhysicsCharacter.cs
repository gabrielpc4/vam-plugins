...
public class DAZPhysicsCharacter : MonoBehaviour
{
	...
	public void copyOthers()
	{
		...
		{
			if (TransformMap.TryGetValue(component2.name, out var value2))
			{
		...
		{
			if (TransformMap.TryGetValue(component3.name, out var value3))
			{
		...
		{
			if (TransformMap.TryGetValue(component4.name, out var value4))
			{
		...
		{
			if (TransformMap.TryGetValue(component5.name, out var value5))
			{
		...
		{
			if (TransformMap.TryGetValue(component6.name, out var value6))
			{
