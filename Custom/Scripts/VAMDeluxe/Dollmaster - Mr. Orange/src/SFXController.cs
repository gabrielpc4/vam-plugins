...
namespace DeluxePlugin.Dollmaster
{
    public class SFXController : BaseModule
    {
        ...
        public void Play()
        {
            ...
            if (dm.thrustController.sliderValue < dm.thrustController.slider.slider.maxValue * 0.0f)
            {
            ...
            {
                audioSource.volume = 0.5f + ((dm.thrustController.sliderValue - 0.75f) / dm.thrustController.slider.slider.maxValue) * 0.125f;
