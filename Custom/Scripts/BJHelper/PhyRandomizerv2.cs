...
namespace MVRPlugin {
	...
	public class PhyRandomizer : MVRScript {
	    ...
	    protected float forceMinDefault = -100;
	    protected float forceMax = 500;
	    protected float forceMaxDefault = 100;

	    protected float torqueMin = -50;
	    protected float torqueMinDefault = -5;
	    protected float torqueMax = 50;
	    protected float torqueMaxDefault = 5;

	    protected float torqueSpeedDefault = 30f;
	    protected float forceSpeedDefault = 250f;
	    ...
	    protected void FlipForceTargets()
	    {
	        forceStart = forceTarget;
	        Vector3 forceDirection;
	        forceDirection.x = forceTarget.x * -1;
	        forceDirection.y = forceTarget.y * -1;
	        forceDirection.z = forceTarget.z * -1;
