...
- `GripHandVisibility` and `OverlapFullGrabRelease` are compiled into `GabrielHud.cslist`.
...
- `GripHandVisibility` triggers Spankings and ClothingTouchFallOff merge callbacks owned by `ui-hud`.
