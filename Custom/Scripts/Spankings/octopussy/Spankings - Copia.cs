    ...
    public class Spankings : MVRScript
    {
        ...
        public override void Init()
        {
            try
            {
                ...
                JSONStorable chest = her.containingAtom.GetStorableByID("chest");   
				JSONStorable abdomen2 = her.containingAtom.GetStorableByID("abdomen2");				

                if (false && ARCheek == null)
                ...
                if (AHitAudio == null)
                    ...
                    {
                        parentLinkAtPosition(newAtom, her.containingAtom, abdomen2, "abdomen2");
                        AHitAudio = newAtom;
