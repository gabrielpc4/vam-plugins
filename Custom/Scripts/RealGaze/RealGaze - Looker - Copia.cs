        ...
        */
        ...
        public override void Init() {
            try {
                ...
                pluginLabelJSON.val = "RealGaze Looker 1.9b";
        ...
        protected void PassDownKeys() {
            foreach (Atom atom in SuperController.singleton.GetAtoms().Where(atom => atom.type == "Person")) {
                ScriptSearchResult slave = ScriptSearch(atom, "PA4148415.RealGazeTarget", false);
                if (slave.found) {
                    foreach (JSONStorable receiver in slave.scripts) {
