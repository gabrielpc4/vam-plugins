...
namespace octopussy
{
    ...
    */
    public class RandomAudio
    {
        ...
        /// <summary>
        /// Per-instance (not static) so loud/soft voices do not steal each other's
        /// cutoff timer.
        /// </summary>
        public float playNowWaitTimer = 0f;
        ...
        public bool playRandomDelayedIfClear(AudioSource audioSource, float volume = 1.0f, float minDelay = 0, float maxDelay = 1)
        {
            return playDelayedIfClear(audioSource, volume, UnityEngine.Random.Range(minDelay, maxDelay));
        }

        public bool playDelayedIfClear(AudioSource audioSource, float volume = 1.0f, float delay = 0)
        {
