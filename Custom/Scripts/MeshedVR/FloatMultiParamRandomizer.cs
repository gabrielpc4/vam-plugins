...
namespace HSTA
{
    ...
    public class ParamRandomizer
    {
        ...
        public ParamRandomizer(string aId, JSONStorableFloat aTarget )
        {
            ...
            _period = new JSONStorableFloat(prefix + "period", 0.9f, onPeriodChanged, 0f, 10f, false);
            ...
            _quickness = new JSONStorableFloat(prefix + "quickness", 2f, onFloatChanged, 0f, 100f, true);
            _minVal = new JSONStorableFloat(prefix + "lowerValue", 0f, onFloatChanged, 0f, 1f, false);
            _maxVal = new JSONStorableFloat(prefix + "upperValue", 0.5f, onFloatChanged, 0f, 1f, false);
