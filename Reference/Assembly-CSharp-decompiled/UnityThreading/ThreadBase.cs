...
public abstract class ThreadBase : IDisposable
{
	...
	protected ManualResetEvent exitEvent = new ManualResetEvent(initialState: false);
	...
	public ThreadBase(string threadName)
		: this(threadName, autoStartThread: true)
	{
	}
	...
	public ThreadBase(string threadName, Dispatcher targetDispatcher)
		: this(threadName, targetDispatcher, autoStartThread: true)
	{
	}
